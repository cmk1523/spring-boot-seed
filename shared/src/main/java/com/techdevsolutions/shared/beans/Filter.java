...
public class Filter {
    ...
    public Filter(String term, Integer size, Integer page, String sort, String order, String filters, String filterLogic) {
        this.term = term;
        this.size = size;
        this.page = page;
        this.sort = sort;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(size, filter.size) &&
                ...
                Objects.equals(term, filter.term);
    }

    @Override
    public int hashCode() {

        return Objects.hash(size, page, sort, order, filters, filterLogic, term);
    }
